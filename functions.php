...
/* client redirection starts here. */

/*
 * If the logged in user is not administrator then we'll redirect the user to the client portal.
 */
...
add_action('admin_init', 'redirect_client');

/* client redirection ends here */
...
function jquerymobile_enquee_script()
{
    ...
    if (!is_page('admin') && !is_page('client'))
